...
void LevelBox2::levelbox2Init(char* filename)
{
    glEnable(GL_BLEND);
...
float LevelBox2::get_xpos()
{
    return xPos;
}

float LevelBox2::get_ypos()
{
    return yPos;
}

float LevelBox2::get_width()
{
    return width / 10.3;
}

float LevelBox2::get_height()
{
    return height / 4.78;
}
